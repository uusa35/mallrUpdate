...
class AddonUpdate extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'caption_en' => 'min:3|nullable',
            'caption_ar' => 'min:3|nullable',
            'image' => "image|dimensions:width=1000,height=1000|max:".env('MAX_IMAGE_SIZE').'"',
