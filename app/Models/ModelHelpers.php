...
trait ModelHelpers
{
    ...
    {
        return $this->checkStorageSpaces() ? $this->getStorageSpacesUrl('thumbnail') . ($this->size_chart_image ? $this->size_chart_image : Setting::first()->size_chart) : asset(env('THUMBNAIL') . $this->size_chart_image);
    }
