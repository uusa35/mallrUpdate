...
@section('breadcrumbs')
    {{ Breadcrumbs::render('backend.admin.addon.edit', $element) }}
@endsection
    ...
    <div class="portlet box blue">
        ...
        <div class="portlet-body">
            ...
            <div class="portlet-body form">
                <form class="horizontal-form" role="form" method="POST" action="{{ route('backend.admin.addon.update', $element->id) }}"
                      enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="form-body">
                        <h3 class="form-section">{{ trans('general.edit') .' ' . trans('general.addon') }}</h3>
                        <div class="portlet box blue ">
