...
@section('breadcrumbs')
    {{ Breadcrumbs::render('backend.video.index') }}
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet light ">
                @include('backend.partials.forms.form_title',['title' => trans('general.videos')])
                                        ...
                                        <ul class="dropdown-menu pull-right" role="menu">
                                            ...
                                            <li>
                                                <a data-toggle="modal" href="#" data-target="#basic"
                                                   data-title="Delete"
                                                   data-content="Are you sure you want to delete video ? "
