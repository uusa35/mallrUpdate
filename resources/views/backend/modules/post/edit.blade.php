...
@section('breadcrumbs')
    {{ Breadcrumbs::render('backend.post.edit', $element) }}
@endsection

@section('content')
    <div class="portlet box blue">
        @include('backend.partials.forms.form_title',['title' => trans('general.edit_post')])
        <div class="portlet-body">
            @include('backend.partials._admin_instructions',['title' => trans('general.posts') ,'message' => trans('message.edit_post')])
            <div class="portlet-body form">
                <form class="horizontal-form" role="form" method="POST"
                      action="{{ route('backend.post.update', $element->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="form-body">
                        <h3 class="form-section">{{ trans('general.edit_post') }}</h3>
                        <div class="portlet box blue ">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group {{ $errors->has('title_ar') ? ' has-error' : '' }}">
                                                <label for="title_ar"
                                                       class="control-label required">{{ trans('general.title_ar') }}
                                                    *</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group{{ $errors->has('title_en') ? ' has-error' : '' }}">
                                                <label for="title_en"
                                                       class="control-label required">{{ trans('general.title_en') }}
                                                    *</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <div class="form-group{{ $errors->has('order') ? ' has-error' : '' }}">
                                                <label for="order"
                                                       class="control-label required">{{ trans('general.sequence') }}
                                                    *</label>
                                        ...
                                        @if($element->getCurrentImageAttribute())
                                            <div class="col-lg-1">
                                                <img class="img-responsive img-sm"
                                                     ...
                                                     alt="">
                                                <a href="{{ route("backend.admin.image.clear",['model' => 'post', 'id' => $element->id ,'colName' => 'image']) }}"><i
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="content_ar"
                                                       class="control-label required">{{ trans('general.caption_ar') }}</label>
                                                <textarea type="text" class="form-control tooltips tinymce"
                                                          ...
                                                          maxlength="500">{!! $element->caption_ar  !!}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="caption_en"
                                                       class="control-label required">{{ trans('general.caption_en') }}</label>
                                                <textarea type="text" class="form-control tooltips tinymce"
                                                          data-container="body" data-placement="top"
                                                          data-original-title="{{ trans('message.caption_en') }}"
                                                          id="caption_en" name="caption_en" aria-multiline="true"
                                                          maxlength="500">{!! $element->caption_en  !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
