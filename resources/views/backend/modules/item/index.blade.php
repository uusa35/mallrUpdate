...
@section('breadcrumbs')
    {{ Breadcrumbs::render('backend.admin.item.index') }}
@endsection
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet light ">
                @include('backend.partials.forms.form_title',['title' => trans('general.index_item')])
                <div class="portlet-body">
                    @include('backend.partials._admin_instructions',['title' => trans('general.items') ,'message' => trans('message.index_item')])
                                    ...
                                    <div class="btn-group">
                                        ...
                                        @if(!$element->trashed())
                                            <ul class="dropdown-menu pull-right" role="menu">
                                                <li>
                                                    <a href="{{ route('backend.admin.item.edit',$element->id) }}">
                                                        <i class="fa fa-fw fa-edit"></i> {{ trans('general.edit') }}</a>
                                                </li>
                                                <li>
                                                    <a href="{{ route('backend.activate',['model' => 'item','id' => $element->id]) }}">
                                                ...
                                                <li>
                                                    ...
                                                    <form method="post" id="delete-{{ $element->id }}"
                                                          action="{{ route('backend.admin.item.destroy',$element->id) }}">
                                                        @csrf
                                        ...
                                        @else
                                            <ul class="dropdown-menu pull-right" role="menu">
                                                <li>
                                                    <a href="{{ route('backend.admin.item.restore',$element->id) }}">
