                                ...
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        @if($timings->isNotEmpty())
                                            <div class="col-md-4" id="timings">
                                                <div class="form-group">
                                                    ...
                                                    <select multiple="multiple" class="multi-select"
                                                            id="my_multi_select5" name="timings[]">
                                        ...
                                        @else
                                            ...
                                            <input type="hidden" name="is_packge" value="0">
                                        @endcan
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                @if($addOns->isNotEmpty())
                                                    <div class="col-md-10 hidden" id="addons">
                                                        <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <label class="radio-inline">
                                                            ...
                                                            {{ trans('general.yes') }} </label>
                                                        <label class="radio-inline">
                                                            <input type="radio" name="has_only_items" id="NoHasItems"
                                                                   checked
                                                                   value="0"> {{ trans('general.no') }}</label>
                                                    </div>
                                                </div>
