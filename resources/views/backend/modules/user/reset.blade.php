                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('backend.reset.password') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input disabled id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="" value="{{ $email ?? old('email') }}" required autofocus>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-theme btn-danger">
                                    {{ __('Reset Password') }}
                                </button>
                            </div>
                        </div>
