...
@section('breadcrumbs')
    {{ Breadcrumbs::render('backend.admin.brand.edit', $element) }}
@endsection
@section('content')
    <div class="portlet box blue">
        @include('backend.partials.forms.form_title',['title' => trans('general.edit_brand')])
        <div class="portlet-body">
            @include('backend.partials._admin_instructions',['title' => trans('general.brands') ,'message' => trans('message.edit_brand')])
            <div class="portlet-body form">
                <form class="horizontal-form" role="form" method="POST"
                      action="{{ route('backend.admin.brand.update', $element->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="form-body">
                        <h3 class="form-section">{{ trans('general.edit_brand') }}</h3>
                        <div class="portlet box blue ">
