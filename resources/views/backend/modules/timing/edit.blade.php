...
@section('breadcrumbs')
    {{ Breadcrumbs::render('backend.timing.edit', $element) }}
@endsection
@section('content')
    <div class="portlet box blue">
        @include('backend.partials.forms.form_title',['title' => trans('general.edit_timing')])
        <div class="portlet-body">
            @include('backend.partials._admin_instructions',['title' => trans('general.timings') ,'message' => trans('message.edit_timing')])
            <div class="portlet-body form">
                <form class="horizontal-form" role="form" method="POST"
                      action="{{ route('backend.timing.update', $element->id) }}"
                      enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="form-body">
                        <h3 class="form-section">{{ trans('general.edit_timing') }}</h3>
                        <div class="portlet box blue">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="single" class="form-control select2"
                                                        ...
                                                        @foreach($users as $user)
                                                            <option value="{{ $user->id }}" {{ $element->user_id === $user->id ? 'selected' : null }}>{{ $user->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="single" class="form-control select2"
                                                        ...
                                                        @foreach($services as $service)
                                                            <option value="{{ $service->id }}" {{ $service->id === $element->service_id ? 'selected' : null }}>{{ $service->name_ar }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="single" class="form-control select2" name="day_id">
                                                    ...
                                                    @foreach($days as $day)
                                                        <option value="{{ $day->id }}" {{ $element->day_id === $day->id ? 'selected' : null }}>{{ $day->day }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="radio-inline">
                                                    <input type="radio" name="allow_multi_select"
                                                           {{ $element->allow_multi_select ? 'checked' : null  }}
                                                           id="optionsRadios1"
