                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('longitude') ? ' has-error' : '' }}">
                                            ...
                                            <input id="longitude" type="text" class="form-control" name="longitude" value="{{ $element->longitude }}" placeholder="{{ trans('general.longitude') }}" required autofocus>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group{{ $errors->has('latitude') ? ' has-error' : '' }}">
                                            ...
                                            <input id="latitude" type="text" class="form-control" name="latitude" value="{{ $element->latitude }}" placeholder="{{ trans('general.latitude') }}" required autofocus>
