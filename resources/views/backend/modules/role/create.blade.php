    ...
    <div class="portlet box blue">
        ...
        <div class="portlet-body">
            ...
            <div class="portlet-body form">
                <form class="horizontal-form" role="form" method="POST" action="{{ route('backend.admin.role.store') }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="name" class="form-control"
                                                       ...
                                                       value="{{ old('name_ar') }}" name="name" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="caption_ar" name="caption_ar"
                                                       class="form-control" value="{{ old('caption_ar') }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="caption_en" name="caption_en"
                                                       class="form-control" value="{{ old('caption_en') }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group {{ $errors->has('color') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" id="hue-demo" class="form-control demo"
                                                       data-control="hue" name="color" value="#ff6161">
                                                @if ($errors->has('color'))
                                                    <span class="help-block">
                                                <strong>
                                                    {{ $errors->first('color') }}
                                                    ...
                                                    <div class="radio-list">
                                                        <label class="radio-inline">
                                                            <input type="radio" name="active" id="optionsRadios1"
                                                                   value="1" checked> {{ trans('general.yes') }}
                                                        </label>
                                                        <label class="radio-inline">
                                                ...
                                                <div class="radio-list">
                                                    ...
                                                    <label class="radio-inline">
                                                        <input type="radio" name="is_admin" id="optionsRadios4"
                                                               value="0" checked> {{ trans('general.no') }}</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
