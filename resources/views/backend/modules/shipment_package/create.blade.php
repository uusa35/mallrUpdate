...
@section('content')
    <div class="portlet box blue">
        @include('backend.partials.forms.form_title', ['title' => trans('general.new_package')])
        <div class="portlet-body">
            @include('backend.partials._admin_instructions',['title' => trans('general.packages') ,'message' => trans('message.new_package')])
            <div class="portlet-body form">
                <form class="horizontal-form" role="form" method="POST" action="{{ route('backend.package.store') }}"
                      enctype="multipart/form-data">
                    @csrf
                    <div class="form-body">
                        <h3 class="form-section">{{ trans('general.new_package') }}</h3>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                                <label for="name" class="control-label">{{ trans('general.name_ar') }}
                                                    *</label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group{{ $errors->has('charge_one') ? ' has-error' : '' }}">
                                                <label for="charge" class="control-label">Charge for One KG or Less*</label>
                                                <input id="charge_one"
                                                       type="text"
                                                       class="form-control"
                                                       name="charge_one"
                                                       value="{{ old('charge_one') }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group{{ $errors->has('charge_two') ? ' has-error' : '' }}">
                                                <label for="charge" class="control-label">Charge for 1.5 KG or Less*</label>
                                                <input id="charge_two"
                                                       type="text"
                                                       class="form-control"
                                                       name="charge_two"
                                                       value="{{ old('charge_two') }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group{{ $errors->has('charge_three') ? ' has-error' : '' }}">
                                                <label for="charge_three" class="control-label">Charge for 2 KG or Less*</label>
                                                <input id="charge_three"
                                                       type="text"
                                                       class="form-control"
                                                       name="charge_three"
                                                       value="{{ old('charge_three') }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group{{ $errors->has('charge_four') ? ' has-error' : '' }}">
                                                <label for="charge_four" class="control-label">Charge for greater than 2 KG*</label>
                                                <input id="charge_four"
                                                       type="text"
                                                       class="form-control"
                                                       name="charge_four"
                                                       value="{{ old('charge_four') }}"
