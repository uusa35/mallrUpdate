                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body text-center">
                            ...
                            <div class="alert alert-danger">
                                ...
                                Normal Slides should be width : 1900px x (Height must be 1900px (Intro Slide) or Height 750 (Home Slide))
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body text-center">
                            ...
                            <div class="alert alert-danger">
                                Intro Slide Width is 900px and maxHeight is 1900px </br>
                                Normal Slides should be width : 900px x (Height must be 1900px (Intro Slide) or Height 750px (Home Slide))
                            </div>
                        </div>
                    </div>
                </div>
