@if($element->user->facebook || $element->user->twitter || $element->user->instagram || $element->user->youtube || $element->user->whatsapp)
        ...
        <div class="container">
            <ul class="tt-social-icon justify-content-center">
                ...
                @if($element->user->whatsapp)
                    <li>
                        <a href="https://api.whatsapp.com/send?phone={{ $element->user->whatsapp }}&text={{ env('APP_NAME') }}"><i
                                    class="fa fa-fw fa-whatsapp"></i></a></li>
                @endif
            </ul>
        </div>
    </div>
