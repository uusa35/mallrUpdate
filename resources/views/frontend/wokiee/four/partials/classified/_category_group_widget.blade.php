        ...
        <div style="display: flex; flex : 1; justify-content: center; align-items: center; flex-wrap: wrap; margin : 0.5rem">
            @foreach($element->items as $item)
                <div class="text-center"
                     style="padding : 0.5rem; max-width: 80px; border: 0.5px solid lightgrey; border-radius: 10px; justify-content: center; align-items: center; flex-direction: column; flex-wrap: nowrap">
                    <div>
