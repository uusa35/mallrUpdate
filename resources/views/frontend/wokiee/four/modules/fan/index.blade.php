                                                ...
                                                <div class="tt-description text-center">
                                                    <div class="tt-row">
                                                        <ul class="tt-add-info">
                                                            <li>
                                                                <a href="{{ route('frontend.user.show',$element->id) }}">{{ \Illuminate\Support\Str::limit($element->name,60,'..') }}</a>
                                                            </li>
                                                        </ul>
                                                    ...
                                                    @if($element->caption)
                                                        <h2 class="tt-title">
                                                            <a href="{{ route('frontend.user.show',$element->id) }}">{{ \Illuminate\Support\Str::limit($element->name,35,'..') }}</a>
                                                        </h2>
                                                    @endif
